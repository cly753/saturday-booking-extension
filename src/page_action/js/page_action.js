...
var update = function() {
    ...
    $("#status").text(all.action.reduce(function(a, b) {
        console.log('a', a);
        console.log('b', b);
        console.log('ActionReadable[a]', ActionReadable[a]);
        console.log('ActionReadable[b]', ActionReadable[b]);
        return ActionReadable[a] + ' > ' + ActionReadable[b];
    }, 6));
